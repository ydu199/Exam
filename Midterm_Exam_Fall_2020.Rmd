...
From the second calculation, we can obtain that n=20 with d=0.5 (medium effect size), so it shows that the sample size 
n=7 is not enough.
...
I think this is the first time I analyze on my own data and on a very small data, I am very happy to to discover the
